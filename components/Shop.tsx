  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      if (selectedCategory) {
        ...
        const categoryName = categoryMap[selectedCategory.toLowerCase()] || selectedCategory;
        filtered = getProductsByCategory(categoryName);
      }
      
      // Filter by brand if selected
      if (selectedBrand) {
        filtered = getProductsByBrandSlug(selectedBrand);
      }
